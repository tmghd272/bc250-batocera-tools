...
echo ""
echo "  --frequency   target boost clock in MHz  (valid: 3500-4500)"
echo "  --vid         max CPU core voltage in mV (valid: 950-1325)"
echo "  --temp        CPU+GPU temp limit in degC (default: 90)"
echo "  --keep        keep overclock applied after detect finishes"
echo ""
